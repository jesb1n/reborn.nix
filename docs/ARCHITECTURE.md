...
| --- | --- | --- | --- | --- |
| `s145` | Home server | x86_64 | k3s server | Control plane, primary local-path storage, Traefik, Garage endpoint, and distributed x86_64 builder |
| `nuc7i3` | Intel NUC | x86_64 | agent | On-prem worker |
